...
import 'capa_model.dart';
export 'capa_model.dart';

class CapaWidget extends StatefulWidget {
  const CapaWidget({super.key});

  static String routeName = 'Capa';
  static String routePath = '/Capa';
...
class _CapaWidgetState extends State<CapaWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CapaModel());
                ...
                Column(
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed(CaptacaoWidget.routeName);
                      },
                      child: Container(
                        width: MediaQuery.sizeOf(context).width * 1.0,
                        decoration: BoxDecoration(),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        unawaited(
                          () async {
                            await launchURL(
                                'https://rotas-g-r-bxt65k.flutterflow.app/');
                          }(),
                        );
                      },
                      child: Container(
